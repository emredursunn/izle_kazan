...
const ProfileScreen = () => {
    ...
    return (
        <ImageBackground source={require('../../assets/profile.png')} style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{fontSize:34, fontStyle:'italic', color:'orange', marginBottom:20, fontWeight:'bold'}}>PROFİLİM</Text>
            ...
            <TouchableOpacity onPress={handleSave} style={{ marginTop: 50, marginBottom: 25, borderRadius: 20, borderWidth: 2, padding: 10, paddingHorizontal: 50, backgroundColor: "orange" }}>
                <Text>
                    Kaydet
                </Text>
            </TouchableOpacity>
